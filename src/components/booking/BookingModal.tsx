...
export function BookingModal({ isOpen, onClose, tour }: BookingModalProps) {
  ...
  const onSubmit = async (data: BookingFormData) => {
    ...
    try {
      ...
      if (
        result.paymentUrl &&
        (data.paymentMethod === "momo" || data.paymentMethod === "paypal")
      ) {
      ...
      >
        <div className="text-center py-6">
          ...
          <p className="text-gray-600 mb-6">
            Tài khoản quản trị viên không thể đặt tour. Vui lòng sử dụng tài
            khoản khách hàng để đặt tour hoặc quay lại trang quản trị.
          </p>
    ...
    return (
      ...
      >
        <div className="text-center py-6">
          ...
          <p className="text-gray-600 mb-6">
            Để đặt tour cho khách hàng tại quầy, vui lòng sử dụng trang đặt tour
            dành cho nhân viên.
          </p>
          <div className="space-y-3">
            <Button onClick={onClose} variant="outline" className="w-full">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex items-center justify-between bg-gray-50 rounded-lg p-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setValue("children", Math.min(10, children + 1))
                    }
                    className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 disabled:opacity-50"
                ...
                <div className="space-y-2">
                  {paymentMethods.map((method) => (
                    ...
                    >
                      ...
                      <span
                        className={
                          field.value === method.id ? "font-medium" : ""
                        }
                      >
                        {method.label}
                      </span>
          ...
          <div className="bg-gray-50 rounded-lg p-4 space-y-2">
            <div className="flex justify-between text-sm">
              <span>
                {adults} người lớn × {formatCurrency(tour.price)}
              </span>
            ...
            {children > 0 && (
              <div className="flex justify-between text-sm">
                <span>
                  {children} trẻ em × {formatCurrency(tour.price * 0.5)}
                </span>
          ...
          {paymentPopupBlocked && pendingPaymentUrl && (
            <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
              <p className="text-sm text-amber-800 mb-2">
                <strong>Popup bị chặn!</strong> Trình duyệt đã chặn cửa sổ thanh
                toán.
              </p>
              <Button
                type="button"
          ...
          <p className="text-xs text-center text-gray-500">
            Bằng việc nhấn "Xác nhận đặt tour", bạn đồng ý với các điều khoản và
