...
import { fetchAllPromotions, validatePromoCodeApi } from "@/services/promotionService";
...
interface PromotionsContextType {
    ...
    calculateDiscount: (discountType: DiscountType, discountValue: number, originalPrice: number) => number;
}
...
export function PromotionsProvider({ children }: PromotionsProviderProps) {
    ...
    const applyPromoCode = async (
        ...
        const discountAmount = calculateDiscountFn(result.discountType, result.discountValue, originalPrice);
