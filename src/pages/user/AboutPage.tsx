import { Users, Globe, Award, Heart, MapPin, ShieldCheck, ArrowRight, Star, CheckCircle2 } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container px-4 text-center text-white space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <Badge variant="outline" className="text-white border-white/50 px-4 py-1 text-sm uppercase tracking-widest backdrop-blur-sm">
            Since 2023
          </Badge>
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-tight">
            Khám Phá Thế Giới <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-cyan-200">Theo Cách Của Bạn</span>
          </h1>
          <p className="text-lg md:text-2xl max-w-2xl mx-auto text-slate-200 font-light">
            Chúng tôi kiến tạo những hành trình độc bản, đánh thức mọi giác quan và lưu giữ những khoảnh khắc vô giá.
          </p>
          <div className="pt-8 flex flex-col sm:flex-row gap-4 justify-center">
             <Button size="lg" className="bg-white text-slate-900 hover:bg-slate-100 text-lg px-8 h-14 rounded-full">
              Bắt Đầu Hành Trình
            </Button>
            <Button size="lg" variant="outline" className="bg-transparent border-white text-white hover:bg-white/10 hover:text-white text-lg px-8 h-14 rounded-full backdrop-blur-sm">
              Tìm Hiểu Thêm
            </Button>
          </div>
        </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Visita không chỉ là một công ty du lịch. Chúng tôi là những người kể chuyện, những nhà thám hiểm và những người bạn đồng hành tận tâm trên mỗi bước chân của bạn.
                </p>
              </div>
              ...
              <div className="pt-4">
                <div className="flex items-center gap-4">
                    <div className="flex -space-x-4">
                        {[1,2,3,4].map(i => (
                            <img key={i} className="w-12 h-12 rounded-full border-2 border-background" src={`https://i.pravatar.cc/100?img=${i+10}`} alt="User" />
                        ))}
                    </div>
                    <div className="text-sm">
                        <p className="font-bold text-foreground">Được tin tưởng bởi 10,000+ du khách</p>
        ...
        <div className="container px-4 relative z-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                {[
                    ...
                    <div key={index} className="space-y-2 p-4 rounded-xl hover:bg-white/5 transition-colors">
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-900/50">
        <div className="container px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-4">Giá Trị Cốt Lõi</h2>
            ...
            {[
                ...
                <Card key={i} className="border-none shadow-lg hover:-translate-y-2 transition-transform duration-300">
                    <CardContent className="p-8 space-y-4">
                        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center ${item.color} mb-6`}>
      ...
      <section className="py-4 overflow-hidden">
        <div className="flex gap-4 overflow-x-auto pb-4 snap-x">
            {[
                ...
                <div key={i} className="flex-none w-72 md:w-96 aspect-[4/3] rounded-xl overflow-hidden snap-center">
                    <img src={`${url}?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80`} alt="Gallery" className="w-full h-full object-cover hover:scale-110 transition-transform duration-700" />
                </div>
            ))}
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-2xl">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-4">Gặp Gỡ Đội Ngũ</h2>
                <p className="text-muted-foreground text-lg">
                Những chuyên gia du lịch đầy đam mê đang làm việc không ngừng nghỉ để hiện thực hóa giấc mơ của bạn.
                </p>
            </div>
            <Button variant="outline" className="hidden md:flex">Xem Toàn Bộ Team <ArrowRight className="ml-2 w-4 h-4"/></Button>
          </div>
      ...
      <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container px-4 md:px-6 text-center relative z-10">
          ...
          <p className="text-primary-foreground/80 text-xl max-w-2xl mx-auto mb-10">
            Đăng ký ngay hôm nay để nhận ưu đãi 15% cho chuyến đi đầu tiên của bạn cùng Visita.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            ...
            />
            <Button size="lg" variant="secondary" className="rounded-full h-12 px-8 font-bold">
              Đăng Ký
            </Button>
          </div>
        </div>
