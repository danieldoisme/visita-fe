...
const POPULAR_DESTINATIONS = [
  { name: "Bali", count: "120+ Tours", image: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&w=600&q=80" },
  { name: "Paris", count: "85+ Tours", image: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=600&q=80" },
  { name: "Rome", count: "90+ Tours", image: "https://images.unsplash.com/photo-1552832230-c0197dd311b5?auto=format&fit=crop&w=600&q=80" },
  { name: "Tokyo", count: "75+ Tours", image: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&w=600&q=80" },
];
      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center">
        ...
        <div className="relative z-20 container px-4 md:px-6 flex flex-col items-center text-center space-y-8 pt-20">
          <div className="space-y-4 max-w-3xl animate-in slide-in-from-bottom-8 duration-1000 delay-100">
            <Badge variant="secondary" className="px-4 py-1.5 text-sm font-medium bg-white/20 text-white hover:bg-white/30 border-0 backdrop-blur-sm mb-4">
              Explore the world with us
            </Badge>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white drop-shadow-lg">
              Your Journey Begins <span className="text-primary-foreground text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-cyan-200">Here</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-100 max-w-[700px] mx-auto drop-shadow-md font-light">
              Discover over 5,000+ curated tours and adventures in the world's most beautiful destinations.
            </p>
          </div>
            ...
            <Card className="border-0 shadow-2xl bg-white/95 backdrop-blur-md rounded-2xl overflow-visible">
              <CardContent className="p-3 md:p-4">
                <div className="grid grid-cols-1 md:grid-cols-[1.5fr,1fr,1fr,auto] gap-3">
                      ...
                      {showDestinations && (
                        <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-xl border border-slate-100 z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                          <div className="px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider bg-slate-50">
                            {locationQuery ? "Suggestions" : "Popular Destinations"}
                          </div>
                  ...
                  {/* Search Button */}
                  <Button size="lg" className="h-14 px-8 text-base font-semibold shadow-lg rounded-xl hover:scale-105 transition-transform duration-200">
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">Access to over 500+ destinations across the globe with expert guides.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">We ensure you get the best prices for your tours with no hidden fees.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">Seamless booking process with instant confirmation and 24/7 support.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-4">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-2">Popular Destinations</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {POPULAR_DESTINATIONS.map((dest, idx) => (
              <div key={idx} className="group relative h-[300px] rounded-2xl overflow-hidden cursor-pointer">
                <img 
                  src={dest.image} 
                  alt={dest.name} 
      ...
      <section className="py-20 bg-slate-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Featured Tours</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Hand-picked tours that our travelers love the most. Experience the best of the best.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {FEATURED_TOURS.map((tour) => (
              <Card key={tour.id} className="group border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden rounded-2xl">
                ...
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    <h3 className="font-bold text-xl line-clamp-1 group-hover:text-primary transition-colors">{tour.title}</h3>
                  </div>
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg md:text-xl text-slate-200">
              Join 50,000+ travelers and get exclusive offers, expert tips, and destination guides sent straight to your inbox.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 p-2 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
              ...
              />
              <Button size="lg" className="h-14 px-8 rounded-xl bg-white text-primary hover:bg-slate-100 font-bold text-base">
                Subscribe Now
              </Button>
            </div>
