...
import { ArrowLeft, Compass, Mail, Lock, User, Eye, EyeOff, Facebook } from "lucide-react";
          ...
          <div className="glass-quote rounded-2xl p-8 max-w-lg">
            <blockquote className="space-y-2">
              <p className="text-lg font-medium leading-relaxed">
                &ldquo;To travel is to live. Join our community of explorers and start writing your own adventure story today.&rdquo;
              </p>
              <footer className="text-sm font-semibold pt-4 border-t border-white/20 mt-4">
                Hans Christian Andersen
                <div className="text-xs font-normal opacity-80">Writer & Traveler</div>
              </footer>
            </blockquote>
          </div>
        </div>
